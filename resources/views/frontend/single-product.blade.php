                        ...
                        <div class="col-lg-5 col-md-5">
                            <div class="sp-img_area">
                                <div class="zoompro-border">
                                    <img class="zoompro" src="{{asset('frontend/assets/images/single-product/large-size/1')}}.jpg" data-zoom-image="assets/images/single-product/large-size/1.jpg" alt="Hiraola's Product Image" />
                                </div>
                                <div id="gallery" class="sp-img_slider">
                                    <a class="active" data-image="{{asset('frontend/assets/images/single-product/large-size/1')}}.jpg" data-zoom-image="assets/images/single-product/large-size/1.jpg">
                                        <img src="{{asset('frontend/assets/images/single-product/small-size/1')}}.jpg" alt="Hiraola's Product Image">
                                    </a>
                                    <a data-image="{{asset('frontend/assets/images/single-product/large-size/2')}}.jpg" data-zoom-image="assets/images/single-product/large-size/2.jpg">
                                        <img src="{{asset('frontend/assets/images/single-product/small-size/2')}}.jpg" alt="Hiraola's Product Image">
                                    </a>
                                    <a data-image="{{asset('frontend/assets/images/single-product/large-size/3')}}.jpg" data-zoom-image="assets/images/single-product/large-size/3.jpg">
                                        <img src="{{asset('frontend/assets/images/single-product/small-size/3')}}.jpg" alt="Hiraola's Product Image">
                                    </a>
                                    <a data-image="{{asset('frontend/assets/images/single-product/large-size/4')}}.jpg" data-zoom-image="assets/images/single-product/large-size/4.jpg">
                                        <img src="{{asset('frontend/assets/images/single-product/small-size/4')}}.jpg" alt="Hiraola's Product Image">
                                    </a>
                                    <a data-image="{{asset('frontend/assets/images/single-product/large-size/5')}}.jpg" data-zoom-image="assets/images/single-product/large-size/5.jpg">
                                        <img src="{{asset('frontend/assets/images/single-product/small-size/5')}}.jpg" alt="Hiraola's Product Image">
                                    </a>
                                    <a data-image="{{asset('frontend/assets/images/single-product/large-size/6')}}.jpg" data-zoom-image="assets/images/single-product/large-size/6.jpg">
                                        <img src="{{asset('frontend/assets/images/single-product/small-size/6')}}.jpg" alt="Hiraola's Product Image">
                                    </a>
                                </div>
                            </div>
                        </div>
