                        ...
                        <div class="col-lg-4">
                            <div class="footer-widgets_info">
                                ...
                                <div class="footer-widgets_logo">
                                    <a href="#">
                                        <img src="{{asset('frontend/assets/images/footer/logo/1.png')}}" alt="Hiraola's Footer Logo">
                                    </a>
                                </div>
                    ...
                    <div class="footer-bottom_nav">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="payment">
                                    <a href="#">
                                        <img src="{{asset('frontend/assets/images/footer/payment/1.png')}}" alt="Hiraola's Payment Method">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="copyright">
                                    <span>Copyright &copy; 2021 <a href="index.html">Hiraola.</a> All rights reserved.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="sp-img_area">
                                    ...
                                    "asNavFor": ".sp-img_slider-nav"
                                        ...
                                        <div class="single-slide red">
                                            <img src="{{asset('frontend/assets/images/single-product/large-size/1.jpg')}}" alt="Hiraola's Product Image">
                                        </div>
                                        <div class="single-slide orange">
                                            <img src="{{asset('frontend/assets/images/single-product/large-size/2.jpg')}}" alt="Hiraola's Product Image">
                                        </div>
                                        <div class="single-slide brown">
                                            <img src="{{asset('frontend/assets/images/single-product/large-size/3.jpg')}}" alt="Hiraola's Product Image">
                                        </div>
                                        <div class="single-slide umber">
                                            <img src="{{asset('frontend/assets/images/single-product/large-size/4.jpg')}}" alt="Hiraola's Product Image">
                                        </div>
                                    </div>
                                   ...
                                   "focusOnSelect": true
                                        ...
                                        <div class="single-slide red">
                                            <img src="{{asset('frontend/assets/images/single-product/small-size/1.jpg')}}" alt="Hiraola's Product Thumnail">
                                        </div>
                                        <div class="single-slide orange">
                                            <img src="{{asset('frontend/assets/images/single-product/small-size/2.jpg')}}" alt="Hiraola's Product Thumnail">
                                        </div>
                                        <div class="single-slide brown">
                                            <img src="{{asset('frontend/assets/images/single-product/small-size/3.jpg')}}" alt="Hiraola's Product Thumnail">
                                        </div>
                                        <div class="single-slide umber">
                                            <img src="{{asset('frontend/assets/images/single-product/small-size/4.jpg')}}" alt="Hiraola's Product Thumnail">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
============================================ -->
    ...
    <!-- Scroll Top JS -->
    <script src="{{asset('frontend/assets/js/plugins/scroll-top.min.js')}}"></script>
    ...
    <!-- Timecircles JS -->
    <script src="{{asset('frontend/assets/js/plugins/timecircles.min.js')}}"></script>
    <!-- Mailchimp Ajax JS -->
...
<!-- Mirrored from template.hasthemes.com/hiraola/hiraola/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Mar 2022 07:53:23 GMT -->
</html>