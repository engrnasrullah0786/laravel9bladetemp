                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="shipping-item">
                                ...
                                <div class="shipping-content">
                                    ...
                                    <p>Healthy food and drink 2021</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="banner-item img-hover_effect">
                            <a href="shop-left-sidebar.html">
                                <img class="img-full" src="{{asset('frontend/assets/images/banner/1_5.jpg')}}" alt="Hiraola's Banner">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="banner-item img-hover_effect">
                            <a href="shop-left-sidebar.html">
                                <img class="img-full" src="{{asset('frontend/assets/images/banner/1_6.jpg')}}" alt="Hiraola's Banner">
                            </a>
                        </div>
                    </div>
                </div>
